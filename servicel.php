...
<header class="header sticky">
      <nav class="main-nav">
        <ul class="main-nav-list">
          <li class="main-nav-link" onclick="window.location.href='index.html'">
            <svg
  ...
  <img src="img/2914527.jpg" alt="" class="img1" />
		<div id="LoginAndRegistrationForm">
			...
			<div id="formSwitchBtn">
				<button onclick="ShowLoginForm()"  id="ShowLoginBtn" class="active" style="background-color:#04AA6D">Service Login</button>
