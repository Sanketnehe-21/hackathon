<div class="container main">
  <div class="row">
  <h1 style="margin-left: 30rem; margin-bottom:2rem;">Service Provider Profile's</h1>
<?php
include 'config.php';

$msg = "";
$uploads_path = "uploads/";
$sql = "SELECT * FROM servicer";
                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <a href="view_pdf2.php?id=<?php echo $row['id']; ?>" class="btn btn-primary" target="_blank">View PDF</a>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="Admin.php">User
              </a>
            </li>
            <li class="nav-item">
