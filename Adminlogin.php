...
// session_start();
include 'config.php'; // Assuming your database configuration is in 'config.php'
...
<header class="header sticky">
	...
	<div class="container">
  <img src="img/2914527.jpg" alt="" class="img1" />
		<div id="LoginAndRegistrationForm">
			<h1 id="formTitle">Login</h1>
			<div id="formSwitchBtn">
				<button onclick="ShowLoginForm()"  id="ShowLoginBtn" class="active" style="background-color:#04AA6D">Admin Login</button>
            ...
            <form action="" method="post">
					...
					<div class="center mt-20">
						<input onclick="return ValidateLoginForm();"  class="Submit-Btn" type="submit" name="submit1" value="Login" id="LoginBtn" style="background-color:#04AA6D">
					</div>
				</form>
