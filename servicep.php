...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $name = $email = $phone_number = $city = $describer = $image = $pdf_document = "";
    ...
    $describer = mysqli_real_escape_string($conn, $_POST['describer']);
    ...
    $sql = "INSERT INTO servicer (name, email, phone_number, city, describer, image, pdf_document) VALUES ('$name', '$email', '$phone_number', '$city', '$describer', '$image', '$pdf_document')";
...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg bg-body-tertiary">
    ...
    <h1 style="margin-left: 34rem; margin-bottom:-2rem;">Service Provider Application Form</h1>
    <form method="post" enctype="multipart/form-data" class="input_form">
      ...
      <div class="mb-3">
        ...
        <div id="imageHelp" class="form-text">
          Please upload relevant documents in single pdf only!!.
        </div>
      </div>
